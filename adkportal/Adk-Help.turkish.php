...
$txt['adkhelp_news_size_img'] = 'Blocklardaki resme sýnýr yok<br /> 0 ile sýnýrý baðýmsýz yapabilirsin. ';
$txt['adkhelp_news_limit_topics'] = 'Block gösterilcek konularý sýnýrla';
$txt['adkhelp_activate'] = 'Aktif veya Kapalý. Bilgi:Baðýmsýz url ile portalýnýzý baþka urlde çalýþtýrabilirsiniz.';
$txt['adkhelp_url_stand'] = 'Sadece \'Anasayfa\' URL deðil. Baðýmsýz mod için.';
$txt['adkhelp_hide_version'] = 'Portal sürümünü gizle.';
$txt['adkhelp_change_title'] = 'Portal baþlýðýný forumdan baðýmsýz eyle.';
$txt['width_portal_2'] = 'Kolonlarýn enini ayarlayýn.Enin px sýnýrýna göre þekillenceðini unutma.';
