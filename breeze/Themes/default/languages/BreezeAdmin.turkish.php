...
$txt['Breeze_page_welcome'] = '&quot;Breeze Yönetici Paneli&quot;.   Buradan Breeze ayarlarýný düzenleyebilirsiniz. Herhangi bir sorunuz varsa <a href="http://missallsunday.com" target="_blank" class="new_win">Yazarýn sitesinden</a> destek istemekten çekinmeyin.';
...
$txt['Breeze_page_donate_exp'] = 'Breeze, serbest zamanýnda bir PHP meraklýsý tarafýndan getirilen ücretsiz bir SMF modifikasyonudur.<p /> Bu modifikasyonu beðenirseniz ve takdirinizi göstermek istiyorsanýz, lütfen bir <a href="http://missallsunday.com/">baðýþ yapýn</a>.  Baðýþýnýz sunucu giderlerini karþýlamak ve / veya ayakkabý satýn almak,
